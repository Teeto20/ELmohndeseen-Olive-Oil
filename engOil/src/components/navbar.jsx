    ...
    <nav className="p-2 border-b border-gray-300 sticky top-0 z-40 dark:bg-gray-900 dark:border-gray-700 bg-white">
      ...
      <ul
        className={`transition-all duration-300
          ...
          ${
            open
              ? "flex absolute left-0 top-12 w-full bg-white dark:bg-gray-900 shadow-lg py-4 px-2 z-50"
              : "hidden"
          } sm:static sm:flex sm:bg-transparent sm:shadow-none sm:py-0 sm:px-0`}
      >
        {links.map((link) => (
